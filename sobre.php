  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Cursos da sua empresa. <span class="text-muted"></span></h2>
          <p class="lead">Cursos podem ser ministrados dentro da própria empresa em horários flexíveis.</p>
        </div>
        <div class="col-md-5">
